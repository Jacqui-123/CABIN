...
-Select only kick net samples, sample # = 1, and calculate the total abundance for each unique site. Individual taxa are removed for now.
...
```{r, echo = FALSE}
#get rid of extraneous/double columns 
#df_benthic <- df_benthic %>%
